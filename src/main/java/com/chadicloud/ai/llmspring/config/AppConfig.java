...
public class AppConfig {
    ...
    public AstraDbEmbeddingStore astraDbEmbeddingStore() {
        String astraToken1 = env.getProperty("astra.token");
        ...
        return new AstraDbEmbeddingStore(AstraDbEmbeddingConfiguration
                ...
                .keyspace(keySpace)
                .table(tableName) // table name should not have hyphens or spaces
    ...
    public ConversationalRetrievalChain conversationalRetrievalChain() {
        return ConversationalRetrievalChain.builder()
                .chatLanguageModel(OpenAiChatModel.withApiKey(env.getProperty("spring.ai.openai.api-key")))
